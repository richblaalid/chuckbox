...
|---|---|---|---|
| PLATFORM-023 | CHUCK-9: migration `20260712000002_fix_payment_link_fee_balance.sql` (dev push) — `process_payment_link_payment` fees-passed branch now credits 5600 for the payer surcharge (net + fee = base + surcharge); RAISEs if 5600 missing while a fee/surcharge line is due; overpayment sweep intentionally preserved for CHUCK-12 | 2026-07-12 | (this commit) |
